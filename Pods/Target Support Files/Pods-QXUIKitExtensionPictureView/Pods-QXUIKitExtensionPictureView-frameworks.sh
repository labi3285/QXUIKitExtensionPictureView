...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QXDSImageBrowse/QXDSImageBrowse.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QXUIKitExtension/QXUIKitExtension.framework"
